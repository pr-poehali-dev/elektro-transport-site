          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-6 md:gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                <GlowCard glowIntensity="high" className="overflow-hidden bg-gradient-to-br from-[#3a3f47] to-[#2a2e35] backdrop-blur-sm">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  {product.youtubeUrl && (
                    <GlowCard glowIntensity="low" hoverEffect={false} className="hidden md:block bg-gradient-to-br from-[#3a3f47] to-[#2a2e35] backdrop-blur-sm">
                      <GlowCardContent className="p-4 md:p-6">
            ...
            <div className="lg:sticky lg:top-24 space-y-4 h-fit">
              <GlowCard glowIntensity="high" hoverEffect={false} className="bg-gradient-to-br from-[#3a3f47] to-[#2a2e35] backdrop-blur-sm">
                <GlowCardContent className="p-4 md:p-6">
              ...
              {/* Order Form */}
              <GlowCard id="order-form" glowIntensity="high" hoverEffect={false} className="bg-gradient-to-br from-[#3a3f47] to-[#2a2e35] backdrop-blur-sm">
                <GlowCardContent className="p-4 md:p-6">
